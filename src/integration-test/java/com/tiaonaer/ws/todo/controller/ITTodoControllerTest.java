package com.tiaonaer.ws.todo.controller;
...
public class ITTodoControllerTest {
    ...
    public void addAsAnonymous_AllFieldsOk_ShouldReturnStatusUnauthorized() throws Exception {
        ...
        mockMvc.perform(post("/api/todo")
                .contentType(com.tiaonaer.ws.IntegrationTestUtil.APPLICATION_JSON_UTF8)
                .content(com.tiaonaer.ws.IntegrationTestUtil.convertObjectToJsonBytes(added))
        )
    ...
    public void addAsUser_AllFieldsOk_ShouldReturnAddedTodo() throws Exception {
        ...
        mockMvc.perform(post("/api/todo")
                .contentType(com.tiaonaer.ws.IntegrationTestUtil.APPLICATION_JSON_UTF8)
                .content(com.tiaonaer.ws.IntegrationTestUtil.convertObjectToJsonBytes(added))
                .with(userDetailsService(com.tiaonaer.ws.IntegrationTestUtil.CORRECT_USERNAME))
        )
                .andExpect(status().isOk())
                .andExpect(content().contentType(com.tiaonaer.ws.IntegrationTestUtil.APPLICATION_JSON_UTF8))
    ...
    public void updateAsAnonymous_TodoFound_ShouldReturnStatusUnauthorized() throws Exception {
        ...
        mockMvc.perform(put("/api/todo/{id}", 1L)
                .contentType(com.tiaonaer.ws.IntegrationTestUtil.APPLICATION_JSON_UTF8)
                .content(com.tiaonaer.ws.IntegrationTestUtil.convertObjectToJsonBytes(updated))
        )
                .andExpect(status().isUnauthorized());
    }
